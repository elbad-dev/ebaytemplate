...
const TemplateEditor: React.FC<TemplateEditorProps> = ({ template, onBack }) => {
  ...
  // Always use the original uploaded template as the base, and only replace the gallery section
  useEffect(() => {
    if (template && template.html) {
      setGeneratedHtml(replaceGallerySection(template.html, templateData.images));
    } else {
