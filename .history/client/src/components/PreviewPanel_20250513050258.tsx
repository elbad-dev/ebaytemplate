      ...
      <div className="lg:col-span-2 h-full">
        <Card className="h-full flex flex-col">
          <div className="p-4 border-b border-gray-200 flex items-center justify-between">
            ...
            className="flex-1 p-4 bg-gray-100 relative"
            style={{
          ...
          >
            {showHtmlView ? (
              <div className="bg-white mx-auto shadow-sm transition-all duration-200 h-full p-4 overflow-auto">
                <textarea
                  className="w-full h-[calc(100vh-250px)] font-mono text-sm border rounded p-2 mb-2"
                  value={editableHtml}
              ...
              <div 
                className="bg-white mx-auto shadow-sm transition-all duration-200 h-full overflow-hidden"
                style={{ 
