...
const PreviewPanel: React.FC<PreviewPanelProps> = ({ 
  ...
  return (
    <>
      <div className="lg:col-span-2 h-[calc(100vh-12rem)]"> {/* Increased height */}
        <Card className="h-full flex flex-col">
          ...
          >
            {showHtmlView ? (
              <div className="bg-white mx-auto h-full p-4">
              ...
              <div 
                className="bg-white mx-auto transition-all duration-200 h-full shadow-sm rounded-lg overflow-hidden relative"
                style={{ 
                  width: previewMode === 'desktop' ? '100%' : previewWidth || getPreviewWidth(),
                  minHeight: '800px', // Increased from previous value
