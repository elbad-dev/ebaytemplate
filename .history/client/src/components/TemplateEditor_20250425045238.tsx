  ...
  const generatePreview = (templateData: TemplateData) => {
    if (template?.html) {
      try {
        ...
        // Handle gallery section last as it might be the most complex
