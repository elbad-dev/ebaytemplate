  ...
  const generatePreview = (templateData: TemplateData) => {
    if (template?.html) {
      try {
        ...
        // Update company name related elements
        updateContent(
          ['.company-name', '.brand-name', '.merchant-name', '.company-title', '.brand-title', '.business-name', '.store-name'],
          templateData.company_name
        );

        // Update subtitle/slogan if present
        updateContent(
          ['.company-subtitle', '.company-slogan', '.brand-slogan', '.store-subtitle'],
