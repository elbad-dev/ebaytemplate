    ...
    <>
      <div className="lg:col-span-2">
        <Card>
          ...
          <CardContent className="overflow-auto p-4 bg-gray-100">
            <div 
              className="bg-white mx-auto transition-all duration-300 overflow-visible" 
              style={{ width: '100%', maxWidth: getPreviewWidth() }}
            >
              <iframe 
                ref={iframeRef}
                className="w-full border-0" 
                style={{ minHeight: 600, height: 'auto', display: 'block' }}
