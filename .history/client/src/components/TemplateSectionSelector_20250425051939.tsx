...
export default function TemplateSectionSelector({ 
  ...
  const handleElementClick = (event: MouseEvent) => {
    ...
    if (hoveredElement) {
      hoveredElement.classList.remove('outline', 'outline-2', 'outline-primary', 'outline-offset-2');
    }
              ...
              <div className="grid grid-cols-2 gap-4">
                {commonSelectors.company.map((selector) => (
                  <Button 
                    ...
                    className={cn(
                      "selector-button",
                      selectedSelector === selector ? "selector-button-selected" : "selector-button-default"
                    )}
                  >
                    {selector}
                  </Button>
            ...
            <div className="section-preview">
              {highlightedSection ? (
                <div 
                  ...
                  className="section-preview-content selected-section"
                />
              ) : (
