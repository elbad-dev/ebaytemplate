  ...
  return `
    <div class="gallery product-gallery">
      ...
      <style>
        ...
        /* Only the currently selected thumbnail gets the green border */
        ${showThumbSelectors} { border-color: var(--primary, #3b82f6) !important; box-shadow: none !important; z-index: auto; }
      </style>
    </div>
  `;
}