  ...
  return `
    <div class="gallery product-gallery">
      ...
      <style>
        ...
        .thumbnail-set { display: flex; justify-content: center; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 0.5rem; /* No border, no background, no padding */ }
        ...
        /* Only the selected thumbnail gets the green border, not the set */
        ${showThumbSelectors} { border-color: var(--primary, #3b82f6) !important; box-shadow: 0 0 0 2px var(--primary, #3b82f6)33; z-index: 2; }
      </style>
    </div>
  `;
}