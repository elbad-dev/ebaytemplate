...
export function generateGallerySection(images: {url: string, alt?: string}[]): string {
  ...
  // Generate simplified navigation arrows with target labels
  ...
  // Generate circular navigation selectors
  const arrowNavigationSelectors = images.map((_, idx) => `
  ...
  return `
    <div class="gallery product-gallery">
      ...
      <style>
        ...
        /* Navigation arrows and circular navigation */
        ${arrowNavigationSelectors}
      </style>
    </div>
  `;
}