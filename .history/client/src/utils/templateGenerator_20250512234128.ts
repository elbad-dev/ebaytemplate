      ...
      <style>
        * {
        ...
        .thumbnail {
          width: 80px;
          height: 80px;
          border: 2px solid var(--frame-border, #e5e7eb);
        ...
        .thumbnail:active {
          ...
          border-color: var(--frame-border, #e5e7eb) !important;
  ...
  return `
    <div class="gallery product-gallery">
      ...
      <style>
        ...
        .thumbnail { width: 80px; height: 80px; border: 2px solid var(--frame-border, #e5e7eb); border-radius: var(--radius, 4px); overflow: hidden; cursor: pointer; flex-shrink: 0; background: #f9f9f9; outline: none; box-shadow: none; transition: border-color 0.2s, box-shadow 0.2s, background 0.2s; }
        .thumbnail:focus,
        .thumbnail:active {
          outline: none !important;
          box-shadow: none !important;
        ...
        /* Highlight the selected thumbnail in any set */
        ${images.map((_, idx) =>
          `#img${idx + 1}:checked ~ .thumbnail-sets label[for="img${idx + 1}"]`
        ).join(',\n')} {
          border-color: #3b82f6 !important; /* or your highlight color */
          background: #e6f0fa !important;   /* optional: subtle background */
        }
      </style>
    </div>
  `;
