  ...
  return `
    <div class="gallery product-gallery">
      ...
      <style>
        ...
        .thumbnail { width: 80px; height: 80px; border: 2px solid var(--frame-border, #e5e7eb); border-radius: var(--radius, 4px); overflow: hidden; cursor: pointer; flex-shrink: 0; background: #f9f9f9; }
